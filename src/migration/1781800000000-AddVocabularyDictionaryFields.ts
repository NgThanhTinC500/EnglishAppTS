...
export class AddVocabularyDictionaryFields1781800000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vocabulary" ADD "partOfSpeech" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vocabulary" DROP COLUMN "partOfSpeech"`);
    }
}
